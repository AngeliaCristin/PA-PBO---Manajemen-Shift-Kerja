 ...
 * @author adham
 */
public class JadwalShiftKaryawan extends javax.swing.JFrame {

    /**
     * Creates new form JadwalShiftKaryawan
     */
    public JadwalShiftKaryawan() {
        initComponents();
        Database.connect();
        table();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JadwalShiftKaryawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new JadwalShiftKaryawan().setVisible(true);
            }
        });
    }
